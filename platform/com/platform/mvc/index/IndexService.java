...
public class IndexService extends BaseService {
	...
	public List<Menu> menu(String systemsIds, User user, String i18nColumnSuffix){
		...
		for (Menu oneMenu : oneList) {
			// 二级菜单
			List<Menu> twoList = Menu.dao.find(twoSql, oneMenu.getPKValue(), userIds, userIds);
//			for (Menu twoMenu : twoList) { // 如果配置三级菜单，则放开此段注释
//				// 三级菜单
//				List<Menu> threeList = Menu.dao.find(twoSql, twoMenu.getPKValue(), userIds, userIds);
//				twoMenu.put("subList", threeList);
//			}
